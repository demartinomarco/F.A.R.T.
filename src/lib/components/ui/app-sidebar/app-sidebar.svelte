...
<Sidebar.Root class="">
	<Sidebar.Content class="p-4">
		<button class="sr-only" type="button">Sidebar opened</button>
		<Sidebar.Group>
			<Sidebar.GroupLabel class="text-md px-0! font-medium text-black">Filter</Sidebar.GroupLabel>
